...
const CACHE = 'mi-dia-v42';
const ARCHIVOS = ['./', './index.html', './app.js', './programa.js', './comidas.js', './salidas.js', './planes.js', './ejercicios.js', './reuniones-datos.js', './reuniones.js', './tareas.js', './manifest.json', './icono.svg'];
